...
const StudentEntryModel = ({ number, from, setShowModal }) => {
  ...
  const handleSave = () => {
    ...
    try {
      if (!!Roll && !!StudentName && !!checkInTime) {
        const newEntry = {
          number: Roll,
    ...
    <Container data-from={from}>
      <InnerContainer>
        ...
        <FormWrapper>
          ...
          <InputWrapper data-from={from}>
            <InputTextbox type='text' required='required' ref={StudentNameRef} />
...
export default StudentEntryModel;
